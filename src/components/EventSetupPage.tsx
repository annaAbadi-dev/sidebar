...
interface EventFormData {
  ...
  // Replace 'any' with PermissionsData once defined
  // ... other steps data
}

export default function EventSetupPage() {
  const { eventId } = useParams<{ eventId: string }>() // Example: if event ID comes from URL
  const [currentEventName] = useState('Demo AC Competition') // Placeholder
  ...
  const handleDataChange = (
    stepId: keyof EventFormData,
    newData: NameAndDetailsData // Extend this union as you add more step data types
  ) => {
