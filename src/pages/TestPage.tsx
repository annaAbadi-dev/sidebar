      ...
      <Tabs defaultValue="short_content" className="w-full">
        ...
        <div className="mt-4">
          <TabsContent value="short_content">
            <p>This is the content for the first tab. The header layout should be correct.</p>
          </TabsContent>
          <TabsContent value="long_content">
            <div className="bg-slate-100 p-4 rounded-md">
                <p>This tab has different, longer content to simulate a complex component.</p>
                <p>The header layout above should remain perfectly stable and correctly spaced out, regardless of the content here.</p>
            </div>
          </TabsContent>
        </div>
      </Tabs>
